...
simulate_data <- function(N, seed) {
  ...
  lambda1<-rate*exp(betas1[1]*x1+betas1[2]*x2+betas1[3]*x3+betas1[4]*x4+betas1[5]*x5+betas1[6]*x6+
                       betas1[7]*x7+betas1[8]*x8+betas1[9]*x9+
                       betas1[10]*x10+betas1[11]*x11+betas1[12]*x12)
  lambda2<-rate*exp(betas2[1]*x1+betas2[2]*x2+betas2[3]*x3+betas2[4]*x4+betas2[5]*x5+betas2[6]*x6+
                       betas2[7]*x7+betas2[8]*x8+betas2[9]*x9+
                       betas2[10]*x10+betas2[11]*x11+betas2[12]*x12)
...
write.csv(results,'Linear_results_new.csv')
